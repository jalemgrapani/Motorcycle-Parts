...
// Fetch Indonesian parts from DB
$query = "SELECT * FROM motorcycle_parts WHERE concept='Indonesian'";
...
<head>
    ...
    <title>Admin - Indonesian Motorcycle Parts</title>
    <link rel="stylesheet" href="../css/admin_indo_con.css">
    <script>
        // Add stock via AJAX
        ...
        function addCustomItem() {
            ...
            if (!partName) return;
            const concept = prompt("Enter Concept:", "Indonesian");
            if (!concept) return;
...
<body>
    ...
    <div class="catalog-container">
        <h1>🏁 Indonesian Motorcycle Parts</h1>
