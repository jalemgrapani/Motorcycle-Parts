<?php
// admin_circuit_con.php
include("../config/connect.php"); // DB connection

// Fetch Circuit Concept parts from DB
...
<head>
    ...
    <title>Admin - Circuit Motorcycle Parts</title>
    <link rel="stylesheet" href="../css/admin_circuit_con.css">
    <script>
        // Add stock via AJAX
        ...
        function addCustomItem() {
            ...
            if (!partName) return;
            const concept = prompt("Enter Concept:", "Circuit");
            if (!concept) return;
...
<body>
    ...
    <div class="catalog-container">
        <h1>🏁 Circuit Motorcycle Parts</h1>
