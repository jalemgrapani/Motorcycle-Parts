...
<head>
    ...
    <title>Admin - Thailand Motorcycle Parts</title>
    <link rel="stylesheet" href="../css/admin_thailand_con.css">
    <script>
        // Add stock via AJAX
        ...
        function addCustomItem() {
            ...
            if (!partName) return;
            const concept = prompt("Enter Concept:", "Thailand");
            if (!concept) return;
...
<body>
    ...
    <div class="catalog-container">
        <h1>🏁 Thailand Motorcycle Parts</h1>
